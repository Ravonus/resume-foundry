...
export const env = createEnv({
  ...
  server: {
    ...
    EDENAI_RESUME_MODEL: z.string().optional(),
    EDENAI_RESUME_USE_AI: z.string().optional(),
    ...
    EDENAI_RESUME_MAX_PROMPT_CHARS: z.coerce.number().optional(),
    EDENAI_RESUME_MAX_TOKENS: z.coerce.number().optional(),
  ...
  runtimeEnv: {
    ...
    EDENAI_RESUME_MODEL: process.env.EDENAI_RESUME_MODEL,
    EDENAI_RESUME_USE_AI: process.env.EDENAI_RESUME_USE_AI,
    ...
    EDENAI_RESUME_MAX_PROMPT_CHARS:
      process.env.EDENAI_RESUME_MAX_PROMPT_CHARS,
    EDENAI_RESUME_MAX_TOKENS: process.env.EDENAI_RESUME_MAX_TOKENS,
